...
export default function Navbar() {
  return (
    <div className="m-0 p-0 font-serif z-0">
        <div className="bg-neutral-800 flex flex-row justify-between text-center text-white">
            <div className="">
                <h1 className="text-2xl text-yellow-300">KINGDOMS SMP</h1>
                <h3 className="text-xl text-zinc-300">A Minecraft Server</h3>
                <h5 className="text-l" style={{color: "#194dff"}}>by drewsterp</h5>
            </div>
            <div className="">
                <Link className="mx-2 text-yellow-200 text-l hover:text-slate-200 active:text-cyan-200" to="/">home</Link>
                <Link className="mx-2 text-yellow-200 text-l hover:text-slate-200 active:text-cyan-200" to="/features">features</Link>
                <Link className="mx-2 text-yellow-200 text-l hover:text-slate-200 active:text-cyan-200" to="/ambitions">ambitions</Link>
            </div>
        </div>
        <Outlet />
