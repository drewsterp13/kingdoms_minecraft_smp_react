            ...
            <div className="relative">
                ...
                <div className="text-white z-10 absolute w-full h-full top-0 bg-neutral-700 bg-opacity-75">
                    <div className="absolute top-1/4 w-full bg-transparent">
                        ...
                        <h5 className="text-base text-cyan-300">by drewsterp</h5>
                    </div>
                </div>
            </div>

            
            <h3 className="text-xl sm:text-2xl mt-8">Greetings kingdom builders</h3>
            <p className="">Welcome to drewsterp's KINGDOMS SMP Minecraft Sever where you can be part of a kingdom to build a cool city, or the most formittable forts, or conquer the end.</p>
            <h3 className="text-xl sm:text-2xl mt-8">Coming soon in Feburary, 2025</h3>
